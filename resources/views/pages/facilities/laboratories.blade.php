...
<section class="product padding-120">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-xs-12 post-item-pagination">
                ...
                <div class="product-items">
                        ...
                        <div class="pro-item">
                            <div class="pro-image cd-item" id="prdct1">
                                ...
                                <img src="storage/banner1.jpg"
                                    style="height: 260px; width:100%;" alt="product image" class="img-responsive">
                            ...
                            <div class="pro-content" style="height: 100px !important;">
                                <strong><a href="#">Robotics Lab</a></strong>
                            </div><!-- pro-content -->
                        </div> <!-- pro item -->
                    </div><!-- product-item -->
                    ...
                    <div class="product-item-grid">
                        <div class="pro-item">
                            ...
                            <div class="pro-content" style="height: 100px !important;">
                                <strong><a href="#">Language Laboratory</a></strong>
                            </div><!-- pro-content -->
                        </div> <!-- pro item -->
                    </div><!-- product-item -->
                    ...
                    <div class="product-item-grid">
                        <div class="pro-item">
                            ...
                            <div class="pro-content" style="height: 100px !important;">
                                <strong><a href="#">Mathematics Laboratory</a></strong>
                            </div><!-- pro-content -->
                        </div> <!-- pro item -->
                    </div><!-- product-item -->
