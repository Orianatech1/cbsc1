                        ...
                        <div class="menu-area w-100">
                            {{-- <ul class="menu-search-cart">
                                <li class="menu-button">
                                    <a href="Admission/admission_page_display/8.html"
                                        class="button-default blinking-button" style="font-size: smaller !important;">
                                        Short-term Courses Offered
                                    </a>
                                </li>
                                <li class="menu-button">
                                    <a href="Admission/admission_page_display/6.html"
                                        class="button-default blinking-button" style="font-size: smaller !important;">
